    ...
    def __init__(self):
        ...
        self.intent_keywords = {
            ...
            Intent.SCHOOL_INFO: [
                ...
                "خصائص", "خدمات الطلاب", "تاريخ التاسيس", "النجاح باليعر", "المدير العام",
                "معلومات المدرسه"
            ],
            ...
            Intent.QUERY_FACILITIES: [
                "مكتبه", "مختبر", "عياده", "مسرح", "صاله رياضيه",
                "ملعب", "مرافق", "غرفه التمريض", "العيادة الطبية", "المكتبة المركزية"
            ]
        }
        ...
        self.known_facilities = [
            "المكتبة المركزية", "مكتبة", "مختبر الفيزياء",
            "العيادة المدرسية", "العيادة الطبية", "عيادة", "الصالة الرياضية", "المسرح المدرسي", "الملعب"
        ]
...
if __name__ == "__main__":
    ...
    test_queries = [
        ...
        "وين تقع مدرسة النجاح باليعر ورقم التواصل؟",
